    ...
    void CheckForInteractables()
    {
        ...
        foreach (Collider collider in hitColliders)
        {
            ...
            if (interactable != null)
            {
                ...
                Vector3 directionToObjet = (collider.transform.position - playerTransform.position).normalized;
                float angle = Vector3.Angle(playerTransform.forward, directionToObjet);
