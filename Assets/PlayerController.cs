    ...
    void CheckGroundded()
    {
        ...
        if ( isGrounded && velocity.y < 0)
        {
            ...
            if(!wasGrounded && animator != null)
            {
                ...
                EffentManager.Instance.PlayEffect("착지이펙트", transform.position);
            }
        }
    }
    ...
    void HandleAttack()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Alpha1) && !isAttacking)
        {
            ...
            if (animator != null)
            {
                ...
                EffentManager.Instance.PlayEffectWithDelay("공격이펙트", effectPos.transform.position, Quaternion.identity, 0.5f, 1.0f);

            }
        }
    }

    public void SetCursorLock(bool IockCursor)
    {
       if(IockCursor)
        {
